...
overview: 'Amazon Web Services (AWS) publishes its API surface across 230 provider profiles indexed on
  the APIs.io network, of which 230 carry a rating. The rated members span 73.6 points, from 82.4 down
  to 8.8.
