...
members_unrated: []
name: Salesforce
overview: 'Salesforce publishes its API surface across 19 provider profiles indexed on the APIs.io network,
  of which 19 carry a rating. The rated members span 52.6 points, from 57.6 down to 5.0.
