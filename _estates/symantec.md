...
overview: 'Symantec publishes its API surface across 4 provider profiles indexed on the APIs.io network,
  of which 4 carry a rating. The rated members span 9.5 points, from 14.5 down to 5.0.


  Its highest-rated surfaces are Bluecoat (Symantec), Elastica, Brightmail, Fireglass.'
